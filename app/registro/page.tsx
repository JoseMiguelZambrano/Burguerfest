...
export const metadata: Metadata = {
  title: "Registro",
  description:
    "Regístrate en Burger Fest 2026. Inscribe tu restaurante o conviértete en patrocinador del festival gastronómico más importante.",
  openGraph: {
    title: "Registro | Burger Fest 2026",
    description:
      "Inscribe tu restaurante o conviértete en patrocinador de Burger Fest 2026.",
  },
};
