...
export const metadata: Metadata = {
  ...
  description:
    "Inscribe tu restaurante en Burger Fest 2026. Completa el formulario y participa en el festival gastronómico más importante de hamburguesas.",
  openGraph: {
    title: "Registro de Restaurante | Burger Fest 2026",
    description:
      "Inscribe tu restaurante en Burger Fest 2026 y participa en el festival gastronómico más importante.",
  },
};
