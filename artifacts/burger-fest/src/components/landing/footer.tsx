        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <a href="#eventos" className="text-background/70 hover:text-background transition-colors text-sm">
                  Eventos
                </a>
              </li>
              <li>
                <a href="#restaurantes" className="text-background/70 hover:text-background transition-colors text-sm">
                  Restaurantes
                </a>
              </li>
              <li>
                <a href="#patrocinadores" className="text-background/70 hover:text-background transition-colors text-sm">
                  Patrocinadores
                </a>
              </li>
            </ul>
