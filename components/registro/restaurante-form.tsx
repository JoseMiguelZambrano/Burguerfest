        ...
        <CardContent className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="space-y-2">
            ...
            <Input
              id="platoEstrella"
              name="platoEstrella"
              placeholder="Tu mejor hamburguesa"
              value={formData.platoEstrella}
              onChange={handleInputChange}
              required
            />
          </div>
        ...
        <CardContent>
          <div className="space-y-2">
            ...
            <Textarea
              id="descripcion"
              name="descripcion"
              placeholder="Cuéntanos sobre tu restaurante, tu especialidad y por qué deberías participar en Burger Fest..."
          ...
          <div className="space-y-4">
            ...
            >
              ...
              <p className="text-foreground font-medium mb-1">
                Arrastra tu video aquí o Selecciona Archivo
              </p>
              ...
              <div className="flex flex-col md:flex-row gap-4 p-4 bg-muted/50 rounded-lg">
                ...
                <div className="flex-1 flex flex-col justify-between">
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      Tamaño: {formatFileSize(videoFile.size)}
                    </p>
                  </div>
                  <Button
                    type="button"
